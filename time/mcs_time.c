...
static MCS_CLOCK_S g_mcs_clock;
...
uint64_t GendotNETDateTime(MCS_CLOCK_S mcs_clock){
...
uint32_t get_miliseconds_since_midnight(MCS_CLOCK_S mcs_clock){
...
uint16_t get_days_since_jan_1_1984(MCS_CLOCK_S mcs_clock){
	uint16_t rtnval = 0;
	uint8_t i_8 = 0;
	uint16_t i_16 = 0;
