...
#line 36 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
...
#line 37 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
...
#line 38 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
#line 1 "..\\..\\Include\\nrf_delay.h"
...
#line 39 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
...
#line 40 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
...
#line 41 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
#line 1 "..\\..\\Include\\nrf_gpio.h"
...
#line 42 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
...
#line 43 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
...
#line 44 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
#line 45 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
#line 1 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.h"
...
#line 46 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
...
)
{
	...
	*spi_tx_data_ptr = command;
	...
	case (0x4B):
		{
			...
			for(data_cycle = 0; data_cycle < Number_Of_Dummy_Bytes; data_cycle++, j++)
			*(spi_tx_data_ptr + j) = 0x00;
	...
	spi_master_send_recv(SPI_MASTER_0, spi_tx_data_ptr, j, data_buffer, Number_Of_Read_Bytes);
...
)
{
	...
	spi_master_send_recv(SPI_MASTER_0, spi_tx_data_ptr, j, data_buffer, Number_Of_Written_Bytes);
...
const _Bool lsb)
{
	...
	spi_master_config_t spi_config = { (0x80000000UL), 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, APP_IRQ_PRIORITY_LOW, (1UL), (0UL), (0UL), 0 };;
	...
	case SPI_MASTER_0:
		{
			...
			spi_config.SPI_Pin_SCK = 11u;
			spi_config.SPI_Pin_MISO = 23u;
			spi_config.SPI_Pin_MOSI = 24u;
			spi_config.SPI_Pin_SS = 5u;
			spi_config.SPI_CONFIG_CPHA = (0UL);
			spi_config.SPI_CONFIG_CPOL = (0UL);
		}
		break; 


#line 398 "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"
	...
	do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 406, (uint8_t*) "..\\Spansion_SLLD_v13.2.1\\Hals\\nRF51xxx\\slld_hal.c"); } while (0); } } while (0);
...
void spi_EEPROM_init(){
	...
	nrf_gpio_cfg_output(5u);
	 
	nrf_gpio_cfg_output(6U);
	 
	nrf_gpio_cfg_output(9U);
