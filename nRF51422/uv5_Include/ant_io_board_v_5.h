...
#define LEDS_MASK			(LED_0 | LED_1 | LED_2 | LED_3)
#define LEDS_INV_MASK	~(LEDS_MASK)

#define BSP_LED_0_MASK	LED_0
#define BSP_LED_1_MASK	LED_2
#define BSP_LED_2_MASK	LED_3
...
#define BUTTONS_MASK	(BUTTON_0 | BUTTON_1 | BUTTON_2 | BUTTON_3)
